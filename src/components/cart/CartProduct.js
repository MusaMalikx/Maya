                    ...
                    <div className="d-flex align-items-center text-start text-md-center row">
                        <div className="col-md-5 d-flex flex-row justify-content-between align-items-center">
                            <div className="d-flex align-items-center justify-content-center">
                                <p>
                                    <img src={props.pic} alt="product1" width="80px" height="80px" />
                                </p>
                                <div className="text-start ms-3">
                                    <p className="text-uppercase text-dark"><strong>{props.name}</strong></p>
                                    <div className="text-muted text-sm">Size: {props.size}</div>
                                    <div className="text-muted text-sm">Color: {props.color}</div>
                                </div>
                            </div>
                        ...
                        <div className="mt-4 mt-md-0  col-md-7 col-12">
                            <div className="align-items-center row">
                                ...
                                <div className="d-none d-md-block text-center col-md-2">
