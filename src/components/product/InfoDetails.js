...
const InfoDetails = () => {
    return (
        ...
        <h1 className= {`${styles.heading1} mb-4 text-4xl`}>Modern Jacket</h1>
        ...
        <form>
            <div className="row">
                ...
                <input style={{maxWidth: "5rem", textAlign: "center"}}  type="number"  name="quantity" className="form-control " />
                </div>
            </div>

            <button className={`btn btn-dark btn-lg ${styles.btncart} mb-5`}>
            ...
            <div className="list-unstyled">
                ...
                <p className="text-muted link" >Jackets and tops</p>
            </div>
