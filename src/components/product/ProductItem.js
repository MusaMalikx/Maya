        ...
        <div className="m-2">
            <div className="relative w-[210px] mb-2" onMouseEnter={() => setHover(true)} onMouseLeave={() => setHover(false)}>
                <div className="border-b-2 border-b-black flex w-[250px]" >
                    ...
                    <img src={items.pic} width={250} height={354} alt="last viewed 1" />
                </div>

                {
                    hover &&
                    <div className="h-[377px] w-[250px] absolute bg-[#fffffe] top-0 bg-opacity-75 text-white flex justify-center items-center border-b-2 border-b-sky-600">
